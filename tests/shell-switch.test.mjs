...
test("the renderer paints aiw-console through the shell hooks exactly as measured (2 objectives, 42 runs)", async () => {
  ...
  assert.match(consoleFiles, /2 objectives \/ 18 phases \/ 42 runs/);
